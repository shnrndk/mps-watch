...
def generate_dashboard():
    ...
    stats_table.add_row("Total Unified Memory", fmt_gb(mem["total"]))
    stats_table.add_row("Used Unified Memory", fmt_gb(mem["used"]))
    stats_table.add_row("Available Unified Memory", fmt_gb(mem["available"]))
